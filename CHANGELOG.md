...
Whilst further maintenance changes are envisaged in SDK 1.16 (e. g. schematron rule maintenance, national eForms extensions, etc) such further changes might not be complete in this Beta release yet. 
...
* Introduction of code list ‘undisclosed-data-group’
...
Please note that this is a non-exhaustive list and does not cover the details of all changes. 
