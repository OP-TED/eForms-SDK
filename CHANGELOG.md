...
A comprehensive list of changes between SDK 1.9.3 and SDK 1.9.4 can be seen at <https://github.com/OP-TED/eForms-SDK/compare/1.9.3...1.9.4>

You can explore the changes between those versions at <https://docs.ted.europa.eu/eforms-sdk-explorer?base=1.9.3&version=1.9.4>
