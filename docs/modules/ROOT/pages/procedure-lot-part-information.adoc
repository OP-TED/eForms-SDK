...
[source,xpath,subs=attributes]
----
cac:CallForTendersDocumentReference{zwsp}[cbc:DocumentType/text()='restricted-document']/cbc:DocumentTypeCode{zwsp}[@listName='communication-justification']
----
...
[source,xpath,subs=attributes]
----
cac:CallForTendersDocumentReference{zwsp}[cbc:DocumentType/text()='restricted-document']/cac:Attachment/cac:ExternalReference/cbc:URI
----
...
2. If Procedure Type (BT-107) isfootnote:[Possible Procedure codes are from the https://op.europa.eu/web/eu-vocabularies/dataset/-/resource/dataset/procurement-procedure-type[Procurement Procedure Type] codelist: "open", "oth-single", "neg-wo-call", "restricted", "neg-w-call", "comp-dial", "innovation", "oth-mult".]:
...
http://publications.europa.eu/resource/dataset/requirement-stage[requirement-stage]
codelist.
...
[source,xml]
----
<cbc:LatestSecurityClearanceDate>2019-11-15</cbc:LatestSecurityClearanceDate>
----
...
the
https://op.europa.eu/web/eu-vocabularies/dataset/-/resource/dataset/permission[permission]
...
https://op.europa.eu/web/eu-vocabularies/dataset/-/resource/dataset/language[language]
...
"_cbc:DocumentStatusCode_" element with any of the two values: "official"
and "non-official".
...
"_cbc:CompanyLegalFormCode_" element. It is expressed using any of the
...
Associated to this criterion may be specified one or more numbers
(BT-541), each with its associated dimension (BT-5421, BT-5422 or
BT-5423). For a given number, only one dimension shall be defined.

The number dimension shall be:

* for weights, elements from the
https://op.europa.eu/web/eu-vocabularies/at-dataset/-/resource/dataset/number-weight[number-weight]
codelist;

* for fixed values, elements from the
https://op.europa.eu/web/eu-vocabularies/at-dataset/-/resource/dataset/number-fixed[number-fixed]
list; and

* for threshold values, elements from the
...
[source,xpath,subs=attributes]
----
cac:ProcessJustification{zwsp}[cbc:ProcessReasonCode/@listName='no-esubmission-justification']/cbc:Description
----
...
<cac:InvitationSubmissionPeriod>
    <cbc:StartDate>2019-11-15</cbc:StartDate>
</cac:InvitationSubmissionPeriod>
----
...
----
<cac:ProcessJustification>
    <cbc:ProcessReasonCode listName="procedure-accelerated">true</cbc:ProcessReasonCode>
...
|*Green Procurement (BT-774)* |xref:strategicProcurementSection[xrefstyle=short] |-- |-- h|? |-- |-- h|? |-- h|? 
a|
[source,xpath,subs=attributes]
----
...
|*Social Procurement (BT-775)* |xref:strategicProcurementSection[xrefstyle=short] |-- |-- h|? |-- |-- h|? |-- h|? 
a|
[source,xpath,subs=attributes]
----
...
|*Innovative Procurement (BT-776)* |xref:strategicProcurementSection[xrefstyle=short] |-- |-- h|? |-- |-- h|? |-- h|? 
a|
[source,xpath,subs=attributes]
----
...
|*Strategic Procurement Description (BT-777)* |xref:strategicProcurementSection[xrefstyle=short] |-- |-- h|? |-- |-- h|? |-- h|? 
a|
[source,xpath,subs=attributes]
----
...
|*Strategic Procurement (BT-06)* |xref:strategicProcurementSection[xrefstyle=short] |-- |-- h|? |-- |-- h|? |-- h|? 
a|
[source,xpath,subs=attributes]
----
...
|*Accessibility Justification (BT-755)* |xref:strategicProcurementSection[xrefstyle=short] |-- |-- h|? |-- |-- h|? |-- h|? a|
[source,xpath,subs=attributes]
----
cac:ProcurementAdditionalType{zwsp}/cbc:ProcurementType
----

|*Accessibility (BT-754)* |xref:strategicProcurementSection[xrefstyle=short] |-- |-- h|? |-- |-- h|? |-- h|? a|
[source,xpath,subs=attributes]
----
cac:ProcurementAdditionalType{zwsp}/cbc:ProcurementTypeCode
----
...
|*Quantity (BT-25)* |xref:strategicProcurementSection[xrefstyle=short] |-- |-- h|? |-- |-- h|? |-- h|? 
a|
[source,xpath,subs=attributes]
----
...
|*Unit (BT-625)* |xref:strategicProcurementSection[xrefstyle=short] |-- |-- h|? |-- |-- h|? |-- h|? 
a|
[source,xpath,subs=attributes]
----
...
|*Suitable for SMEs (BT-726)* |xref:quantitySection[xrefstyle=short] |-- h|? h|? h|? h|? h|? |-- |-- a|
[source,xpath,subs=attributes]
----
...
** Additional Natures must must not be duplicated,
...
=== Strategic Procurement (BT-06, BT-754, BT-755, BT-774, BT-775, BT-776, BT-777)
...
for accessibility related procurement BT-754)
...
The Strategic Procurement description (BT-777) or the Accessibility
justification (BT-755) shall be marked using the "_cbc:ProcurementType_"
...
<cac:ProcurementAdditionalType>
    ...
    <cbc:ProcurementType languageID="ENG">This is a strategic procurement on ...</cbc:ProcurementType>
    <cbc:ProcurementType languageID="FRA">Il s'agit d'une fourniture stratégique ...</cbc:ProcurementType>
</cac:ProcurementAdditionalType>

<cac:ProcurementAdditionalType>
    <cbc:ProcurementTypeCode listName="environmental-impact">emas-com</cbc:ProcurementTypeCode>
    <cbc:ProcurementType languageID="ENG">The selection criteria ...</cbc:ProcurementType>
    <cbc:ProcurementType languageID="FRA">Les critères de sélection ...</cbc:ProcurementType>
</cac:ProcurementAdditionalType>
----
...
<cac:PlannedPeriod>
    <cbc:StartDate>2019-11-15</cbc:StartDate>
    <cbc:EndDate>2019-11-19</cbc:EndDate>
</cac:PlannedPeriod>
----
...
* cbc:MaximumNumberNumeric shall be a positive integer (when no
extension is foreseen, the element shouldn't be used,
