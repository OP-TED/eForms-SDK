...
to specify whether the legal person is a natural person or not.
...
* there are multiple buyers and one act as a group leader
...
|*Appeal Information Providing Organization* |Organization providing
...
a|[source,xpath,subs=attributes]
----
/*/TenderingTerms{zwsp}/cac:TenderRecepientParty 
----
