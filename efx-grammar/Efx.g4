...
stringFunction
    ...
    | StringFunction                 OpenParenthesis booleanExpression                        CloseParenthesis                                                                                                          # booleanToStringFunction
    | StringFunction                 OpenParenthesis dateExpression                           CloseParenthesis                                                                                                          # dateToStringFunction
    | StringFunction                 OpenParenthesis timeExpression                           CloseParenthesis                                                                                                          # timeToStringFunction
    | StringFunction                 OpenParenthesis durationExpression                       CloseParenthesis                                                                                                          # durationToStringFunction
    | StringFunction                 OpenParenthesis lateBoundScalar                          CloseParenthesis                                                                                                          # ppToStringFunction
