...
<pattern id="EFORMS-validation-stage-1b-33" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingTerms[$noticeSubType = '33']">
		<assert id="ND-PartProcurementDocument-33" role="ERROR" diagnostics="ND-PartProcurementDocument" test="count(cac:CallForTendersDocumentReference) = 0">rule|text|ND-PartProcurementDocument-33</assert>
