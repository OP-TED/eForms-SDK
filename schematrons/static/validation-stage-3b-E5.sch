...
<pattern id="EFORMS-validation-stage-3b-E5" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/*/cbc:RegulatoryDomain[$noticeSubType = 'E5']">
		<assert id="BR-BT-00001-0253" role="ERROR" test="normalize-space(.) = ('32009L0081', '32014L0023', '32014L0024', '32014L0025', '32024R2509', 'other')">rule|text|BR-BT-00001-0253</assert>
	</rule>
</pattern>
