...
<pattern id="EFORMS-validation-stage-2a-12" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/*/cac:TenderingProcess[$noticeSubType = '12']">
		...
		<assert id="BR-BT-00634-0172" role="ERROR" diagnostics="BT-634-Procedure" test="count(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efbc:ProcedureRelaunchIndicator) = 0">rule|text|BR-BT-00634-0172</assert>
