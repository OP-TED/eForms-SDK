...
<pattern id="EFORMS-validation-stage-2a-4" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="/*/cac:ContractingParty">
        <assert id="R-E5M-U84" role="ERROR" diagnostics="ND-ContractingParty_BT-10-Procedure-Buyer" test="cac:ContractingActivity[cbc:ActivityTypeCode/@listName='authority-activity']/cbc:ActivityTypeCode[@listName='authority-activity']">rule|text|R-E5M-U84</assert>
        <assert id="R-H9D-VB3" role="ERROR" diagnostics="ND-ContractingParty_BT-11-Procedure-Buyer" test="cac:ContractingPartyType[cbc:PartyTypeCode/@listName='buyer-legal-type']/cbc:PartyTypeCode[@listName='buyer-legal-type']">rule|text|R-H9D-VB3</assert>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Part']">
        <assert id="R-ZX2-L0B" role="ERROR" diagnostics="ND-Part_BT-137-Part" test="cbc:ID">rule|text|R-ZX2-L0B</assert>
    </rule>
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Part']/cac:ProcurementProject">
        <assert id="R-MG3-EBT" role="ERROR" diagnostics="ND-PartProcurementScope_BT-21-Part" test="cbc:Name">rule|text|R-MG3-EBT</assert>
        <assert id="R-5NC-TQC" role="ERROR" diagnostics="ND-PartProcurementScope_BT-23-Part" test="cbc:ProcurementTypeCode[@listName='contract-nature']">rule|text|R-5NC-TQC</assert>
        <assert id="R-ZJO-Y4B" role="ERROR" diagnostics="ND-PartProcurementScope_BT-24-Part" test="cbc:Description">rule|text|R-ZJO-Y4B</assert>
        <assert id="R-IF7-MO3" role="ERROR" diagnostics="ND-PartProcurementScope_BT-262-Part" test="cac:MainCommodityClassification/cbc:ItemClassificationCode">rule|text|R-IF7-MO3</assert>
    </rule>
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Part']/cac:TenderingTerms/cac:AppealTerms">
        <assert id="R-0N4-IWZ" role="ERROR" diagnostics="ND-PartReviewTerms_OPT-301-Part-ReviewOrg" test="cac:AppealReceiverParty/cac:PartyIdentification/cbc:ID">rule|text|R-0N4-IWZ</assert>
    </rule>
    ...
    <rule context="/*">
        ...
        <assert id="R-FDI-85G" role="ERROR" diagnostics="ND-Root_BT-127-notice" test="cbc:PlannedDate">rule|text|R-FDI-85G</assert>
