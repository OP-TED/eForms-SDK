...
<pattern id="EFORMS-validation-stage-2b" xmlns="http://purl.oclc.org/dsdl/schematron">
	<rule context="/*">
		...
		<assert id="OPT-999-notice_R" role="ERROR" diagnostics="OPT-999-notice" test="count(cac:TenderResult/cbc:AwardDate) &lt; 2">rule|text|OPT-999-notice_R</assert>
	</rule>
	...
	<rule context="/*/cac:ContractingParty/cac:ContractingActivity[cbc:ActivityTypeCode/@listName='authority-activity']">
		<assert id="BT-10-Procedure-Buyer_R" role="ERROR" diagnostics="BT-10-Procedure-Buyer" test="count(cbc:ActivityTypeCode[@listName='authority-activity']) &lt; 2">rule|text|BT-10-Procedure-Buyer_R</assert>
	</rule>
