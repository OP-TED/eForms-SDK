...
<!--File generated from metadata database version 1.3.13 created on the 2022-11-10T13:56:32.-->
<pattern id="EFORMS-validation-stage-2b" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/*/cac:ProcurementProject/cac:RequestedTenderTotal">
		...
		<assert id="BT-271-Procedure_R" role="ERROR" diagnostics="BT-271-Procedure" test="count(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efbc:FrameworkMaximumAmount) &lt; 2">rule|text|BT-271-Procedure_R</assert>
	</rule>
	...
	<rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:ProcurementProject/cac:RequestedTenderTotal">
		...
		<assert id="BT-271-Lot_R" role="ERROR" diagnostics="BT-271-Lot" test="count(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efbc:FrameworkMaximumAmount) &lt; 2">rule|text|BT-271-Lot_R</assert>
	</rule>
	...
	<rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingProcess/cac:OpenTenderEvent">
		...
		<assert id="BT-133-Lot_R" role="ERROR" diagnostics="BT-133-Lot" test="count(cac:OccurenceLocation/cbc:Description) &lt; 2">rule|text|BT-133-Lot_R</assert>
	...
	<rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms">
		...
		<assert id="BT-801-Lot_R" role="ERROR" diagnostics="BT-801-Lot" test="count(cac:ContractExecutionRequirement/cbc:ExecutionRequirementCode[@listName='nda']) &lt; 2">rule|text|BT-801-Lot_R</assert>
	...
	<rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:AppealTerms">
		<assert id="BT-99-Lot_R" role="ERROR" diagnostics="BT-99-Lot" test="count(cac:PresentationPeriod/cbc:Description) &lt; 2">rule|text|BT-99-Lot_R</assert>
	...
	<rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='LotsGroup']/cac:ProcurementProject/cac:RequestedTenderTotal">
		...
		<assert id="BT-271-LotsGroup_R" role="ERROR" diagnostics="BT-271-LotsGroup" test="count(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efbc:FrameworkMaximumAmount) &lt; 2">rule|text|BT-271-LotsGroup_R</assert>
	</rule>
	...
	<rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Part']/cac:ProcurementProject/cac:ProcurementAdditionalType">
	...
	<rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:AppealsInformation/efac:AppealStatus">
		...
		<assert id="OPT-092-ReviewBody_R" role="ERROR" diagnostics="OPT-092-ReviewBody" test="count(efac:AppealProcessingParty/efbc:AppealProcessingPartyTypeDescription) &lt; 2">rule|text|OPT-092-ReviewBody_R</assert>
	...
	<rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeResult/efac:LotTender">
		...
		<assert id="BT-780-Tender_R" role="ERROR" diagnostics="BT-780-Tender" test="count(efac:AggregatedAmounts/efbc:PaidAmountDescription) &lt; 2">rule|text|BT-780-Tender_R</assert>
