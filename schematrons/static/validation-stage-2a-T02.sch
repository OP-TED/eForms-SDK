...
<pattern id="EFORMS-validation-stage-2a-T02" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="/*/cac:ContractingParty">
        ...
        <assert id="R-CG1-KVY" role="ERROR" diagnostics="ND-ContractingParty_BT-740-Procedure-Buyer" test="cac:ContractingPartyType[cbc:PartyTypeCode/@listName='buyer-contracting-type']/cbc:PartyTypeCode[@listName='buyer-contracting-type']">rule|text|R-CG1-KVY</assert>
    </rule>
    ...
    <rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeResult/efac:LotResult">
        ...
        <assert id="R-UNL-7NH" role="ERROR" diagnostics="ND-LotResult_BT-144-LotResult" test="not(efac:DecisionReason/efbc:DecisionReasonCode)">rule|text|R-UNL-7NH</assert>
    ...
    <rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeResult/efac:LotTender">
        ...
        <assert id="R-AVH-UYH" role="ERROR" diagnostics="ND-LotTender_OPP-030-Tender" test="efac:ContractTerm[not(efbc:TermCode/text()='all-rev-tic')][efbc:TermCode/@listName='contract-detail']/efbc:TermCode">rule|text|R-AVH-UYH</assert>
        <assert id="R-4X3-CNS" role="ERROR" diagnostics="ND-LotTender_OPP-033-Tender" test="efac:ContractTerm[efbc:TermCode/@listName='rewards-penalties']/efbc:TermCode">rule|text|R-4X3-CNS</assert>
        <assert id="R-860-JT7" role="ERROR" diagnostics="ND-LotTender_OPP-035-Tender" test="efac:ContractTerm[efbc:TermCode/text()='all-rev-tic']/efbc:TermCode">rule|text|R-860-JT7</assert>
    </rule>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms">
        ...
        <assert id="R-S8H-LNV" role="ERROR" diagnostics="ND-LotTenderingTerms_OPT-071-Lot" test="cac:ContractExecutionRequirement[cbc:ExecutionRequirementCode/@listName='customer-service']/cbc:ExecutionRequirementCode">rule|text|R-S8H-LNV</assert>
    ...
    <rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeResult/efac:LotTender/efac:ContractTerm[not(efbc:TermCode/text()='all-rev-tic')][efbc:TermCode/@listName='contract-detail']">
        <assert id="R-HT3-EKH" role="ERROR" diagnostics="ND-OtherContractExecutionConditions_OPP-031-Tender" test="efbc:TermDescription">rule|text|R-HT3-EKH</assert>
    </rule>
    ...
    <rule context="/*/cac:ProcurementProject">
        ...
        <assert id="R-E8H-8XI" role="ERROR" diagnostics="ND-ProcedureProcurementScope_OPP-040-Procedure" test="cac:ProcurementAdditionalType[cbc:ProcurementTypeCode/@listName='transport-service']/cbc:ProcurementTypeCode">rule|text|R-E8H-8XI</assert>
    </rule>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:ContractExecutionRequirement[cbc:ExecutionRequirementCode/@listName='customer-service']">
        <assert id="R-3IA-EGN" role="ERROR" diagnostics="ND-QualityTarget_OPT-072-Lot" test="cbc:Description">rule|text|R-3IA-EGN</assert>
    </rule>
    ...
    <rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeResult/efac:LotTender/efac:ContractTerm[efbc:TermCode/text()='all-rev-tic']">
        <assert id="R-F16-8D2" role="ERROR" diagnostics="ND-RevenueAllocation_OPP-032-Tender" test="efbc:TermPercent">rule|text|R-F16-8D2</assert>
    </rule>
    ...
    <rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeResult/efac:LotTender/efac:ContractTerm[efbc:TermCode/@listName='rewards-penalties']">
        <assert id="R-P06-BSW" role="ERROR" diagnostics="ND-RewardsPenalties_OPP-034-Tender" test="efbc:TermDescription">rule|text|R-P06-BSW</assert>
    </rule>
    <rule context="/*">
