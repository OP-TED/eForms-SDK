...
<pattern id="EFORMS-validation-stage-2a-18" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms">
        <assert id="R-GMP-RG6" role="ERROR" diagnostics="ND-LotTenderingTerms_BT-65-Lot" test="cac:AllowedSubcontractTerms[cbc:SubcontractingConditionsCode/@listName='subcontracting-obligation']/cbc:SubcontractingConditionsCode">rule|text|R-GMP-RG6</assert>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension">
        <assert id="R-M6V-SRH" role="ERROR" diagnostics="ND-NonUBLTenderingTerms_BT-651-Lot" test="efac:TenderSubcontractingRequirements/efbc:TenderSubcontractingRequirementsCode">rule|text|R-M6V-SRH</assert>
