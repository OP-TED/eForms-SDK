...
<pattern id="EFORMS-validation-stage-2a-29" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:AwardingTerms/cac:AwardingCriterion">
        <assert id="R-OFS-YHQ" role="ERROR" diagnostics="ND-LotAwardCriteria_BT-539-Lot" test="cac:SubordinateAwardingCriterion/cbc:AwardingCriterionTypeCode[@listName='award-criterion-type']">rule|text|R-OFS-YHQ</assert>
    </rule>
