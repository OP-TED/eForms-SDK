...
<pattern id="EFORMS-validation-stage-4-27" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/*/cac:TenderingProcess[$noticeSubType = '27']">
		<assert id="BR-BT-00135-0034" role="ERROR" diagnostics="ND-ProcedureTenderingProcess_BT-135-Procedure" test="count(cac:ProcessJustification[cbc:ProcessReasonCode/@listName='direct-award-justification']/cbc:ProcessReason) &gt; 0 or not(cbc:ProcedureCode/normalize-space(text()) = 'neg-wo-call')">rule|text|BR-BT-00135-0034</assert>
		<assert id="BR-BT-00135-0056" role="ERROR" diagnostics="ND-ProcedureTenderingProcess_BT-135-Procedure" test="count(cac:ProcessJustification[cbc:ProcessReasonCode/@listName='direct-award-justification']/cbc:ProcessReason) = 0 or (cbc:ProcedureCode/normalize-space(text()) = 'neg-wo-call')">rule|text|BR-BT-00135-0056</assert>
	</rule>
