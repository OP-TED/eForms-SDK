...
<pattern id="EFORMS-validation-stage-2a-X02" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:ProcurementProject/cac:ProcurementAdditionalType[cbc:ProcurementTypeCode/@listName='accessibility']">
        <assert id="R-58Y-87K" role="ERROR" diagnostics="ND-AccessibilityJustification_BT-755-Lot" test="not(cbc:ProcurementType)">rule|text|R-58Y-87K</assert>
    </rule>
    ...
    <rule context="/*/cac:BusinessParty/cac:PostalAddress">
        <assert id="R-LLH-290" role="ERROR" diagnostics="ND-BusinessAddress_BT-514-Business" test="cac:Country/cbc:IdentificationCode">rule|text|R-LLH-290</assert>
    </rule>
    <rule context="/*/cac:BusinessParty">
        <assert id="R-X6B-JG9" role="ERROR" diagnostics="ND-BusinessParty_BT-501-Business-European" test="cac:PartyLegalEntity[cbc:CompanyID/@schemeName = 'EU']/cbc:CompanyID">rule|text|R-X6B-JG9</assert>
    </rule>
    <rule context="/*/cac:ContractingParty/cac:Party">
        <assert id="R-7OG-6GB" role="ERROR" diagnostics="ND-Buyer_OPT-300-Procedure-Buyer" test="not(cac:PartyIdentification/cbc:ID)">rule|text|R-7OG-6GB</assert>
        <assert id="R-4O1-4MR" role="ERROR" diagnostics="ND-Buyer_OPT-300-Procedure-SProvider" test="not(cac:ServiceProviderParty/cac:Party/cac:PartyIdentification/cbc:ID)">rule|text|R-4O1-4MR</assert>
    </rule>
    ...
    <rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:Changes/efac:Change">
        <assert id="R-41V-86E" role="ERROR" diagnostics="ND-Change_BT-141_a_-notice" test="not(efbc:ChangeDescription)">rule|text|R-41V-86E</assert>
        <assert id="R-14R-QXL" role="ERROR" diagnostics="ND-Change_BT-718-notice" test="not(efbc:ProcurementDocumentsChangeIndicator)">rule|text|R-14R-QXL</assert>
        <assert id="R-JCL-I3O" role="ERROR" diagnostics="ND-Change_BT-719-notice" test="not(efbc:ProcurementDocumentsChangeDate)">rule|text|R-JCL-I3O</assert>
    </rule>
    <rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:Changes/efac:Change/efac:ChangedSection">
        <assert id="R-G6N-V7J" role="ERROR" diagnostics="ND-ChangedSection_BT-13716-notice" test="not(efbc:ChangedSectionIdentifier)">rule|text|R-G6N-V7J</assert>
    </rule>
    <rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:Organizations/efac:Organization/efac:Company">
        <assert id="R-T06-8NX" role="ERROR" diagnostics="ND-Company_BT-16-Organization-Company" test="not(cac:PostalAddress/cbc:Department)">rule|text|R-T06-8NX</assert>
        ...
        <assert id="R-III-J3N" role="ERROR" diagnostics="ND-Company_BT-500-Organization-Company" test="not(cac:PartyName/cbc:Name)">rule|text|R-III-J3N</assert>
        <assert id="R-M9Q-AIC" role="ERROR" diagnostics="ND-Company_BT-501-Organization-Company" test="not(cac:PartyLegalEntity/cbc:CompanyID)">rule|text|R-M9Q-AIC</assert>
        <assert id="R-ZL9-TRZ" role="ERROR" diagnostics="ND-Company_BT-502-Organization-Company" test="not(cac:Contact/cbc:Name)">rule|text|R-ZL9-TRZ</assert>
        <assert id="R-4QS-YFM" role="ERROR" diagnostics="ND-Company_BT-503-Organization-Company" test="not(cac:Contact/cbc:Telephone)">rule|text|R-4QS-YFM</assert>
        <assert id="R-LPY-1LM" role="ERROR" diagnostics="ND-Company_BT-505-Organization-Company" test="not(cbc:WebsiteURI)">rule|text|R-LPY-1LM</assert>
        <assert id="R-0E3-NKJ" role="ERROR" diagnostics="ND-Company_BT-506-Organization-Company" test="not(cac:Contact/cbc:ElectronicMail)">rule|text|R-0E3-NKJ</assert>
        <assert id="R-QW6-U9H" role="ERROR" diagnostics="ND-Company_BT-507-Organization-Company" test="not(cac:PostalAddress/cbc:CountrySubentityCode)">rule|text|R-QW6-U9H</assert>
        <assert id="R-CZH-O96" role="ERROR" diagnostics="ND-Company_BT-509-Organization-Company" test="not(cbc:EndpointID)">rule|text|R-CZH-O96</assert>
        <assert id="R-2MB-2NR" role="ERROR" diagnostics="ND-Company_BT-510_a_-Organization-Company" test="not(cac:PostalAddress/cbc:StreetName)">rule|text|R-2MB-2NR</assert>
        <assert id="R-5VT-R0U" role="ERROR" diagnostics="ND-Company_BT-510_b_-Organization-Company" test="not(cac:PostalAddress/cbc:AdditionalStreetName)">rule|text|R-5VT-R0U</assert>
        <assert id="R-G7X-LYZ" role="ERROR" diagnostics="ND-Company_BT-510_c_-Organization-Company" test="not(cac:PostalAddress/cac:AddressLine/cbc:Line)">rule|text|R-G7X-LYZ</assert>
        <assert id="R-R3C-Z1R" role="ERROR" diagnostics="ND-Company_BT-512-Organization-Company" test="not(cac:PostalAddress/cbc:PostalZone)">rule|text|R-R3C-Z1R</assert>
        <assert id="R-176-FRS" role="ERROR" diagnostics="ND-Company_BT-513-Organization-Company" test="not(cac:PostalAddress/cbc:CityName)">rule|text|R-176-FRS</assert>
        <assert id="R-SPE-E2E" role="ERROR" diagnostics="ND-Company_BT-514-Organization-Company" test="not(cac:PostalAddress/cac:Country/cbc:IdentificationCode)">rule|text|R-SPE-E2E</assert>
        <assert id="R-T0P-VFW" role="ERROR" diagnostics="ND-Company_BT-739-Organization-Company" test="not(cac:Contact/cbc:Telefax)">rule|text|R-T0P-VFW</assert>
        <assert id="R-K42-YYN" role="ERROR" diagnostics="ND-Company_OPT-200-Organization-Company" test="not(cac:PartyIdentification/cbc:ID)">rule|text|R-K42-YYN</assert>
    </rule>
    ...
    <rule context="/*/cac:ContractingParty">
        <assert id="R-VDL-KLJ" role="ERROR" diagnostics="ND-ContractingParty_BT-10-Procedure-Buyer" test="not(cac:ContractingActivity[cbc:ActivityTypeCode/@listName='authority-activity']/cbc:ActivityTypeCode[@listName='authority-activity'])">rule|text|R-VDL-KLJ</assert>
        <assert id="R-X5E-5CA" role="ERROR" diagnostics="ND-ContractingParty_BT-11-Procedure-Buyer" test="not(cac:ContractingPartyType[cbc:PartyTypeCode/@listName='buyer-legal-type']/cbc:PartyTypeCode[@listName='buyer-legal-type'])">rule|text|R-X5E-5CA</assert>
        ...
        <assert id="R-LP7-UUB" role="ERROR" diagnostics="ND-ContractingParty_BT-610-Procedure-Buyer" test="not(cac:ContractingActivity[cbc:ActivityTypeCode/@listName='entity-activity']/cbc:ActivityTypeCode[@listName='entity-activity'])">rule|text|R-LP7-UUB</assert>
        <assert id="R-VMF-6LU" role="ERROR" diagnostics="ND-ContractingParty_BT-740-Procedure-Buyer" test="not(cac:ContractingPartyType[cbc:PartyTypeCode/@listName='buyer-contracting-type']/cbc:PartyTypeCode[@listName='buyer-contracting-type'])">rule|text|R-VMF-6LU</assert>
    </rule>
    ...
    <rule context="/*/cac:AdditionalDocumentReference">
        <assert id="R-NJ3-HMC" role="ERROR" diagnostics="ND-GazetteReference_OPP-120-Business" test="cbc:DocumentDescription">rule|text|R-NJ3-HMC</assert>
        <assert id="R-8OC-TCO" role="ERROR" diagnostics="ND-GazetteReference_OPP-121-Business" test="cbc:ReferencedDocumentInternalAddress">rule|text|R-8OC-TCO</assert>
        <assert id="R-FZ8-OB8" role="ERROR" diagnostics="ND-GazetteReference_OPP-123-Business" test="cbc:IssueDate">rule|text|R-FZ8-OB8</assert>
        <assert id="R-P57-FDX" role="ERROR" diagnostics="ND-GazetteReference_OPP-124-Business" test="cbc:ID">rule|text|R-P57-FDX</assert>
    </rule>
    <rule context="/*/cac:TenderingTerms/cac:LotDistribution/cac:LotsGroup">
        <assert id="R-VXS-DWC" role="ERROR" diagnostics="ND-GroupComposition_BT-1375-Procedure" test="not(cac:ProcurementProjectLotReference/cbc:ID[@schemeName='Lot'])">rule|text|R-VXS-DWC</assert>
    </rule>
    ...
    <rule context="/*/cac:BusinessParty/cac:PartyLegalEntity[cbc:CompanyID/@schemeName = 'national']">
        <assert id="R-CNG-8WM" role="ERROR" diagnostics="ND-LocalEntity_BT-500-Business" test="cbc:RegistrationName">rule|text|R-CNG-8WM</assert>
    </rule>
    <rule context="/*/cac:TenderingTerms/cac:ProcurementLegislationDocumentReference[cbc:ID/text()='LocalLegalBasis']">
        <assert id="R-MXA-BE0" role="ERROR" diagnostics="ND-LocalLegalBasisNoID_BT-01_f_-Procedure" test="not(cbc:DocumentDescription)">rule|text|R-MXA-BE0</assert>
    </rule>
    <rule context="/*/cac:TenderingTerms/cac:ProcurementLegislationDocumentReference[not(cbc:ID/text()=('CrossBorderLaw','LocalLegalBasis'))]">
        <assert id="R-DEQ-WDO" role="ERROR" diagnostics="ND-LocalLegalBasisWithID_BT-01_d_-Procedure" test="not(cbc:DocumentDescription)">rule|text|R-DEQ-WDO</assert>
    </rule>
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']">
        <assert id="R-EEO-D7I" role="ERROR" diagnostics="ND-Lot_BT-137-Lot" test="not(cbc:ID)">rule|text|R-EEO-D7I</assert>
    </rule>
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:ProcurementProject/cac:AdditionalCommodityClassification">
        <assert id="R-XSJ-HJS" role="ERROR" diagnostics="ND-LotAdditionalClassification_BT-26_a_-Lot" test="not(cbc:ItemClassificationCode/@listName)">rule|text|R-XSJ-HJS</assert>
    </rule>
    ...
    <rule context="/*/cac:TenderingTerms/cac:LotDistribution">
        ...
        <assert id="R-F2N-84Y" role="ERROR" diagnostics="ND-LotDistribution_BT-330-Procedure" test="not(cac:LotsGroup/cbc:LotsGroupID)">rule|text|R-F2N-84Y</assert>
    </rule>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:EmploymentLegislationDocumentReference">
        <assert id="R-7UC-2GG" role="ERROR" diagnostics="ND-LotEmploymentLegislation_OPT-113-Lot-EmployLegis" test="not(cbc:ID)">rule|text|R-7UC-2GG</assert>
        <assert id="R-Y68-HU6" role="ERROR" diagnostics="ND-LotEmploymentLegislation_OPT-130-Lot-EmployLegis" test="not(cac:Attachment/cac:ExternalReference/cbc:URI)">rule|text|R-Y68-HU6</assert>
        <assert id="R-UFK-3IR" role="ERROR" diagnostics="ND-LotEmploymentLegislation_OPT-301-Lot-EmployLegis" test="not(cac:IssuerParty/cac:PartyIdentification/cbc:ID)">rule|text|R-UFK-3IR</assert>
    </rule>
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:EnvironmentalLegislationDocumentReference">
        <assert id="R-UH4-3U9" role="ERROR" diagnostics="ND-LotEnvironmentalLegislation_OPT-112-Lot-EnvironLegis" test="not(cbc:ID)">rule|text|R-UH4-3U9</assert>
        <assert id="R-9I4-9FN" role="ERROR" diagnostics="ND-LotEnvironmentalLegislation_OPT-120-Lot-EnvironLegis" test="not(cac:Attachment/cac:ExternalReference/cbc:URI)">rule|text|R-9I4-9FN</assert>
        <assert id="R-6OZ-344" role="ERROR" diagnostics="ND-LotEnvironmentalLegislation_OPT-301-Lot-EnvironLegis" test="not(cac:IssuerParty/cac:PartyIdentification/cbc:ID)">rule|text|R-6OZ-344</assert>
    </rule>
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:FiscalLegislationDocumentReference">
        <assert id="R-IY5-39A" role="ERROR" diagnostics="ND-LotFiscalLegislation_OPT-110-Lot-FiscalLegis" test="not(cac:Attachment/cac:ExternalReference/cbc:URI)">rule|text|R-IY5-39A</assert>
        <assert id="R-1EB-GUC" role="ERROR" diagnostics="ND-LotFiscalLegislation_OPT-111-Lot-FiscalLegis" test="not(cbc:ID)">rule|text|R-1EB-GUC</assert>
        <assert id="R-PDF-7V4" role="ERROR" diagnostics="ND-LotFiscalLegislation_OPT-301-Lot-FiscalLegis" test="not(cac:IssuerParty/cac:PartyIdentification/cbc:ID)">rule|text|R-PDF-7V4</assert>
    </rule>
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:ProcurementProject/cac:MainCommodityClassification">
        <assert id="R-1JC-YF5" role="ERROR" diagnostics="ND-LotMainClassification_BT-26_m_-Lot" test="not(cbc:ItemClassificationCode/@listName)">rule|text|R-1JC-YF5</assert>
    </rule>
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:ProcurementProject/cac:RealizedLocation">
        <assert id="R-MRT-FB0" role="ERROR" diagnostics="ND-LotPlacePerformance_BT-5071-Lot" test="not(cac:Address/cbc:CountrySubentityCode)">rule|text|R-MRT-FB0</assert>
        <assert id="R-2O9-U3M" role="ERROR" diagnostics="ND-LotPlacePerformance_BT-5101_a_-Lot" test="not(cac:Address/cbc:StreetName)">rule|text|R-2O9-U3M</assert>
        <assert id="R-RN0-JNX" role="ERROR" diagnostics="ND-LotPlacePerformance_BT-5101_b_-Lot" test="not(cac:Address/cbc:AdditionalStreetName)">rule|text|R-RN0-JNX</assert>
        ...
        <assert id="R-XOE-ZCT" role="ERROR" diagnostics="ND-LotPlacePerformance_BT-5141-Lot" test="not(cac:Address/cac:Country/cbc:IdentificationCode)">rule|text|R-XOE-ZCT</assert>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:ProcurementProject">
        <assert id="R-DFE-SV4" role="ERROR" diagnostics="ND-LotProcurementScope_BT-06-Lot" test="not(cac:ProcurementAdditionalType[cbc:ProcurementTypeCode/@listName='strategic-procurement']/cbc:ProcurementTypeCode)">rule|text|R-DFE-SV4</assert>
        <assert id="R-4T0-J57" role="ERROR" diagnostics="ND-LotProcurementScope_BT-21-Lot" test="not(cbc:Name)">rule|text|R-4T0-J57</assert>
        <assert id="R-GAZ-1EB" role="ERROR" diagnostics="ND-LotProcurementScope_BT-22-Lot" test="not(cbc:ID)">rule|text|R-GAZ-1EB</assert>
        <assert id="R-034-2N5" role="ERROR" diagnostics="ND-LotProcurementScope_BT-23-Lot" test="not(cbc:ProcurementTypeCode[@listName='contract-nature'])">rule|text|R-034-2N5</assert>
        <assert id="R-XCV-Q2O" role="ERROR" diagnostics="ND-LotProcurementScope_BT-24-Lot" test="not(cbc:Description)">rule|text|R-XCV-Q2O</assert>
        <assert id="R-GJG-GM0" role="ERROR" diagnostics="ND-LotProcurementScope_BT-25-Lot" test="not(cbc:EstimatedOverallContractQuantity)">rule|text|R-GJG-GM0</assert>
        <assert id="R-Y4U-5AE" role="ERROR" diagnostics="ND-LotProcurementScope_BT-262-Lot" test="not(cac:MainCommodityClassification/cbc:ItemClassificationCode)">rule|text|R-Y4U-5AE</assert>
        <assert id="R-E0X-FRN" role="ERROR" diagnostics="ND-LotProcurementScope_BT-263-Lot" test="not(cac:AdditionalCommodityClassification/cbc:ItemClassificationCode)">rule|text|R-E0X-FRN</assert>
        ...
        <assert id="R-Z21-DAH" role="ERROR" diagnostics="ND-LotProcurementScope_BT-300-Lot" test="not(cbc:Note)">rule|text|R-Z21-DAH</assert>
        <assert id="R-NIK-TDL" role="ERROR" diagnostics="ND-LotProcurementScope_BT-531-Lot" test="not(cac:ProcurementAdditionalType[cbc:ProcurementTypeCode/@listName='contract-nature']/cbc:ProcurementTypeCode)">rule|text|R-NIK-TDL</assert>
        <assert id="R-GNX-8OL" role="ERROR" diagnostics="ND-LotProcurementScope_BT-625-Lot" test="not(cbc:EstimatedOverallContractQuantity/@unitCode)">rule|text|R-GNX-8OL</assert>
        ...
        <assert id="R-2MH-SOJ" role="ERROR" diagnostics="ND-LotProcurementScope_BT-754-Lot" test="not(cac:ProcurementAdditionalType[cbc:ProcurementTypeCode/@listName='accessibility']/cbc:ProcurementTypeCode)">rule|text|R-2MH-SOJ</assert>
        <assert id="R-3X8-HHT" role="ERROR" diagnostics="ND-LotProcurementScope_BT-774-Lot" test="not(cac:ProcurementAdditionalType[cbc:ProcurementTypeCode/@listName='environmental-impact']/cbc:ProcurementTypeCode)">rule|text|R-3X8-HHT</assert>
        <assert id="R-8CU-J2H" role="ERROR" diagnostics="ND-LotProcurementScope_BT-775-Lot" test="not(cac:ProcurementAdditionalType[cbc:ProcurementTypeCode/@listName='social-objective']/cbc:ProcurementTypeCode)">rule|text|R-8CU-J2H</assert>
        <assert id="R-FGZ-PBQ" role="ERROR" diagnostics="ND-LotProcurementScope_BT-776-Lot" test="not(cac:ProcurementAdditionalType[cbc:ProcurementTypeCode/@listName='innovative-acquisition']/cbc:ProcurementTypeCode)">rule|text|R-FGZ-PBQ</assert>
        <assert id="R-VXV-0M8" role="ERROR" diagnostics="ND-LotProcurementScope_BT-805-Lot" test="not(cac:ProcurementAdditionalType[cbc:ProcurementTypeCode/@listName='gpp-criteria']/cbc:ProcurementTypeCode)">rule|text|R-VXV-0M8</assert>
    </rule>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:AppealTerms">
        <assert id="R-BTU-1CZ" role="ERROR" diagnostics="ND-LotReviewTerms_BT-99-Lot" test="not(cac:PresentationPeriod/cbc:Description)">rule|text|R-BTU-1CZ</assert>
        <assert id="R-DF0-QWZ" role="ERROR" diagnostics="ND-LotReviewTerms_OPT-301-Lot-Mediator" test="not(cac:MediationParty/cac:PartyIdentification/cbc:ID)">rule|text|R-DF0-QWZ</assert>
        <assert id="R-1K2-KY6" role="ERROR" diagnostics="ND-LotReviewTerms_OPT-301-Lot-ReviewInfo" test="not(cac:AppealInformationParty/cac:PartyIdentification/cbc:ID)">rule|text|R-1K2-KY6</assert>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms">
        ...
        <assert id="R-QEO-QD2" role="ERROR" diagnostics="ND-LotTenderingTerms_BT-60-Lot" test="not(cbc:FundingProgramCode[@listName='eu-funded'])">rule|text|R-QEO-QD2</assert>
        ...
        <assert id="R-LUC-K99" role="ERROR" diagnostics="ND-LotTenderingTerms_OPT-301-Lot-AddInfo" test="not(cac:AdditionalInformationParty/cac:PartyIdentification/cbc:ID)">rule|text|R-LUC-K99</assert>
        <assert id="R-4Z3-VLE" role="ERROR" diagnostics="ND-LotTenderingTerms_OPT-301-Lot-DocProvider" test="not(cac:DocumentProviderParty/cac:PartyIdentification/cbc:ID)">rule|text|R-4Z3-VLE</assert>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='LotsGroup']">
        <assert id="R-28H-LGE" role="ERROR" diagnostics="ND-LotsGroup_BT-137-LotsGroup" test="not(cbc:ID)">rule|text|R-28H-LGE</assert>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='LotsGroup']/cac:ProcurementProject">
        <assert id="R-STU-Y0J" role="ERROR" diagnostics="ND-LotsGroupProcurementScope_BT-21-LotsGroup" test="not(cbc:Name)">rule|text|R-STU-Y0J</assert>
        <assert id="R-CX5-JOO" role="ERROR" diagnostics="ND-LotsGroupProcurementScope_BT-22-LotsGroup" test="not(cbc:ID)">rule|text|R-CX5-JOO</assert>
        <assert id="R-Z76-WVJ" role="ERROR" diagnostics="ND-LotsGroupProcurementScope_BT-24-LotsGroup" test="not(cbc:Description)">rule|text|R-Z76-WVJ</assert>
        ...
        <assert id="R-2I4-RWH" role="ERROR" diagnostics="ND-LotsGroupProcurementScope_BT-300-LotsGroup" test="not(cbc:Note)">rule|text|R-2I4-RWH</assert>
    ...
    <rule context="/*/efac:NoticePurpose">
        <assert id="R-FVU-XM4" role="ERROR" diagnostics="ND-OperationType_OPP-100-Business" test="cbc:PurposeCode">rule|text|R-FVU-XM4</assert>
    </rule>
    ...
    <rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:Organizations/efac:Organization">
        ...
        <assert id="R-IBX-28U" role="ERROR" diagnostics="ND-Organization_OPP-050-Organization" test="not(efbc:GroupLeadIndicator)">rule|text|R-IBX-28U</assert>
        <assert id="R-UV5-F3R" role="ERROR" diagnostics="ND-Organization_OPP-051-Organization" test="not(efbc:AwardingCPBIndicator)">rule|text|R-UV5-F3R</assert>
        <assert id="R-TZ9-8I8" role="ERROR" diagnostics="ND-Organization_OPP-052-Organization" test="not(efbc:AcquiringCPBIndicator)">rule|text|R-TZ9-8I8</assert>
        <assert id="R-12A-UV0" role="ERROR" diagnostics="ND-Organization_OPT-201-Organization-TouchPoint" test="not(efac:TouchPoint/cac:PartyIdentification/cbc:ID)">rule|text|R-12A-UV0</assert>
    ...
    <rule context="/*/cac:ProcurementProject/cac:AdditionalCommodityClassification">
        <assert id="R-HN4-UD9" role="ERROR" diagnostics="ND-ProcedureAdditionalCommodityClassification_BT-26_a_-Procedure" test="not(cbc:ItemClassificationCode/@listName)">rule|text|R-HN4-UD9</assert>
    </rule>
    <rule context="/*/cac:ProcurementProject/cac:MainCommodityClassification">
        <assert id="R-TOF-YKT" role="ERROR" diagnostics="ND-ProcedureMainClassification_BT-26_m_-Procedure" test="not(cbc:ItemClassificationCode/@listName)">rule|text|R-TOF-YKT</assert>
    </rule>
    <rule context="/*/cac:ProcurementProject/cac:RealizedLocation/cac:Address">
        <assert id="R-BTV-ISD" role="ERROR" diagnostics="ND-ProcedurePlacePerformance_BT-5071-Procedure" test="not(cbc:CountrySubentityCode)">rule|text|R-BTV-ISD</assert>
        <assert id="R-12P-4SJ" role="ERROR" diagnostics="ND-ProcedurePlacePerformance_BT-5101_a_-Procedure" test="not(cbc:StreetName)">rule|text|R-12P-4SJ</assert>
        <assert id="R-86R-H9G" role="ERROR" diagnostics="ND-ProcedurePlacePerformance_BT-5101_b_-Procedure" test="not(cbc:AdditionalStreetName)">rule|text|R-86R-H9G</assert>
        <assert id="R-1W7-XBJ" role="ERROR" diagnostics="ND-ProcedurePlacePerformance_BT-5101_c_-Procedure" test="not(cac:AddressLine/cbc:Line)">rule|text|R-1W7-XBJ</assert>
        <assert id="R-NZM-1OL" role="ERROR" diagnostics="ND-ProcedurePlacePerformance_BT-5121-Procedure" test="not(cbc:PostalZone)">rule|text|R-NZM-1OL</assert>
        <assert id="R-BJC-852" role="ERROR" diagnostics="ND-ProcedurePlacePerformance_BT-5131-Procedure" test="not(cbc:CityName)">rule|text|R-BJC-852</assert>
        <assert id="R-WLC-3AY" role="ERROR" diagnostics="ND-ProcedurePlacePerformance_BT-5141-Procedure" test="not(cac:Country/cbc:IdentificationCode)">rule|text|R-WLC-3AY</assert>
        <assert id="R-G51-FB4" role="ERROR" diagnostics="ND-ProcedurePlacePerformance_BT-727-Procedure" test="not(cbc:Region)">rule|text|R-G51-FB4</assert>
    </rule>
    <rule context="/*/cac:ProcurementProject/cac:RealizedLocation">
        <assert id="R-AHX-KLG" role="ERROR" diagnostics="ND-ProcedurePlacePerformanceAdditionalInformation_BT-728-Procedure" test="not(cbc:Description)">rule|text|R-AHX-KLG</assert>
    </rule>
    <rule context="/*/cac:ProcurementProject">
        <assert id="R-NHM-QS9" role="ERROR" diagnostics="ND-ProcedureProcurementScope_BT-21-Procedure" test="not(cbc:Name)">rule|text|R-NHM-QS9</assert>
        <assert id="R-AIY-3E1" role="ERROR" diagnostics="ND-ProcedureProcurementScope_BT-22-Procedure" test="not(cbc:ID)">rule|text|R-AIY-3E1</assert>
        <assert id="R-QGZ-57N" role="ERROR" diagnostics="ND-ProcedureProcurementScope_BT-23-Procedure" test="not(cbc:ProcurementTypeCode)">rule|text|R-QGZ-57N</assert>
        <assert id="R-8E3-HCM" role="ERROR" diagnostics="ND-ProcedureProcurementScope_BT-24-Procedure" test="not(cbc:Description)">rule|text|R-8E3-HCM</assert>
        <assert id="R-D08-Y7G" role="ERROR" diagnostics="ND-ProcedureProcurementScope_BT-262-Procedure" test="not(cac:MainCommodityClassification/cbc:ItemClassificationCode)">rule|text|R-D08-Y7G</assert>
        <assert id="R-H3V-XOW" role="ERROR" diagnostics="ND-ProcedureProcurementScope_BT-263-Procedure" test="not(cac:AdditionalCommodityClassification/cbc:ItemClassificationCode)">rule|text|R-H3V-XOW</assert>
        ...
        <assert id="R-AN6-WV9" role="ERROR" diagnostics="ND-ProcedureProcurementScope_BT-300-Procedure" test="not(cbc:Note)">rule|text|R-AN6-WV9</assert>
        <assert id="R-V5A-LAP" role="ERROR" diagnostics="ND-ProcedureProcurementScope_BT-531-Procedure" test="not(cac:ProcurementAdditionalType[cbc:ProcurementTypeCode/@listName='contract-nature']/cbc:ProcurementTypeCode)">rule|text|R-V5A-LAP</assert>
    ...
    <rule context="/*/cac:TenderingTerms">
        <assert id="R-S1K-0VB" role="ERROR" diagnostics="ND-ProcedureTerms_BT-01_c_-Procedure" test="not(cac:ProcurementLegislationDocumentReference[not(cbc:ID/text()=('CrossBorderLaw','LocalLegalBasis'))]/cbc:ID)">rule|text|R-S1K-0VB</assert>
        <assert id="R-QPH-E6R" role="ERROR" diagnostics="ND-ProcedureTerms_BT-01_e_-Procedure" test="not(cac:ProcurementLegislationDocumentReference[cbc:ID/text()='LocalLegalBasis']/cbc:ID)">rule|text|R-QPH-E6R</assert>
    ...
    <rule context="/*">
        <assert id="R-05O-4U0" role="ERROR" diagnostics="ND-Root_BT-04-notice" test="not(cbc:ContractFolderID)">rule|text|R-05O-4U0</assert>
        <assert id="R-GYS-QL9" role="ERROR" diagnostics="ND-Root_BT-127-notice" test="not(cbc:PlannedDate)">rule|text|R-GYS-QL9</assert>
        <assert id="R-7WF-AIG" role="ERROR" diagnostics="ND-Root_BT-195-notice" test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeInformationNondisclosure/efac:NondisclosureReference/efbc:NondisclosureID)">rule|text|R-7WF-AIG</assert>
        <assert id="R-Q9R-HPM" role="ERROR" diagnostics="ND-Root_BT-196-notice" test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeInformationNondisclosure/efac:NondisclosureJustification/efbc:NondisclosureJustificationDescription)">rule|text|R-Q9R-HPM</assert>
        <assert id="R-46Z-S8L" role="ERROR" diagnostics="ND-Root_BT-197-notice" test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeInformationNondisclosure/efac:NondisclosureJustification/efbc:NondisclosureJustificationCode)">rule|text|R-46Z-S8L</assert>
        <assert id="R-BG4-U13" role="ERROR" diagnostics="ND-Root_BT-198-notice" test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeInformationNondisclosure/efbc:InformationDisclosureDate)">rule|text|R-BG4-U13</assert>
        <assert id="R-R9L-O08" role="ERROR" diagnostics="ND-Root_OPP-105-Business" test="cac:BusinessCapability/cbc:CapabilityTypeCode">rule|text|R-R9L-O08</assert>
    ...
    <rule context="/*/cac:SenderParty/cac:Contact">
        <assert id="R-370-UOV" role="ERROR" diagnostics="ND-SenderContact_OPP-131-Business" test="cbc:ElectronicMail">rule|text|R-370-UOV</assert>
    </rule>
    <rule context="/*/cac:ContractingParty/cac:Party/cac:ServiceProviderParty">
        <assert id="R-OEL-K6P" role="ERROR" diagnostics="ND-ServiceProviderParty_OPT-030-Procedure-SProvider" test="not(cbc:ServiceTypeCode)">rule|text|R-OEL-K6P</assert>
    </rule>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:ProcurementProject/cac:ProcurementAdditionalType[cbc:ProcurementTypeCode/@listName='strategic-procurement']">
        <assert id="R-2R7-M18" role="ERROR" diagnostics="ND-StrategicProcurementType_BT-777-Lot" test="not(cbc:ProcurementType)">rule|text|R-2R7-M18</assert>
    </rule>
    ...
    <rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:Organizations/efac:Organization/efac:TouchPoint">
        <assert id="R-4LZ-POM" role="ERROR" diagnostics="ND-Touchpoint_BT-16-Organization-TouchPoint" test="not(cac:PostalAddress/cbc:Department)">rule|text|R-4LZ-POM</assert>
        <assert id="R-4U5-BMR" role="ERROR" diagnostics="ND-Touchpoint_BT-500-Organization-TouchPoint" test="not(cac:PartyName/cbc:Name)">rule|text|R-4U5-BMR</assert>
        <assert id="R-DT5-C0L" role="ERROR" diagnostics="ND-Touchpoint_BT-502-Organization-TouchPoint" test="not(cac:Contact/cbc:Name)">rule|text|R-DT5-C0L</assert>
        <assert id="R-U4G-HRO" role="ERROR" diagnostics="ND-Touchpoint_BT-503-Organization-TouchPoint" test="not(cac:Contact/cbc:Telephone)">rule|text|R-U4G-HRO</assert>
        <assert id="R-6XU-ZDS" role="ERROR" diagnostics="ND-Touchpoint_BT-505-Organization-TouchPoint" test="not(cbc:WebsiteURI)">rule|text|R-6XU-ZDS</assert>
        <assert id="R-HUN-MH6" role="ERROR" diagnostics="ND-Touchpoint_BT-506-Organization-TouchPoint" test="not(cac:Contact/cbc:ElectronicMail)">rule|text|R-HUN-MH6</assert>
        <assert id="R-BDM-DMT" role="ERROR" diagnostics="ND-Touchpoint_BT-507-Organization-TouchPoint" test="not(cac:PostalAddress/cbc:CountrySubentityCode)">rule|text|R-BDM-DMT</assert>
        <assert id="R-GV5-4RK" role="ERROR" diagnostics="ND-Touchpoint_BT-509-Organization-TouchPoint" test="not(cbc:EndpointID)">rule|text|R-GV5-4RK</assert>
        <assert id="R-38A-UPT" role="ERROR" diagnostics="ND-Touchpoint_BT-510_a_-Organization-TouchPoint" test="not(cac:PostalAddress/cbc:StreetName)">rule|text|R-38A-UPT</assert>
        <assert id="R-NEB-QC8" role="ERROR" diagnostics="ND-Touchpoint_BT-510_b_-Organization-TouchPoint" test="not(cac:PostalAddress/cbc:AdditionalStreetName)">rule|text|R-NEB-QC8</assert>
        <assert id="R-JHH-8H4" role="ERROR" diagnostics="ND-Touchpoint_BT-510_c_-Organization-TouchPoint" test="not(cac:PostalAddress/cac:AddressLine/cbc:Line)">rule|text|R-JHH-8H4</assert>
        <assert id="R-628-8OG" role="ERROR" diagnostics="ND-Touchpoint_BT-512-Organization-TouchPoint" test="not(cac:PostalAddress/cbc:PostalZone)">rule|text|R-628-8OG</assert>
        <assert id="R-1IK-DNO" role="ERROR" diagnostics="ND-Touchpoint_BT-513-Organization-TouchPoint" test="not(cac:PostalAddress/cbc:CityName)">rule|text|R-1IK-DNO</assert>
        <assert id="R-8LF-NTW" role="ERROR" diagnostics="ND-Touchpoint_BT-514-Organization-TouchPoint" test="not(cac:PostalAddress/cac:Country/cbc:IdentificationCode)">rule|text|R-8LF-NTW</assert>
        <assert id="R-CTH-WW0" role="ERROR" diagnostics="ND-Touchpoint_BT-739-Organization-TouchPoint" test="not(cac:Contact/cbc:Telefax)">rule|text|R-CTH-WW0</assert>
    </rule>
