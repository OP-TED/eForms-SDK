...
<pattern id="EFORMS-validation-stage-1b-8" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/*/cac:ProcurementProjectLot[$noticeSubType = '8']">
		...
		<assert id="ND-PartTenderingTerms-8" role="ERROR" diagnostics="ND-PartTenderingTerms" test="count(cac:TenderingTerms) &gt; 0">rule|text|ND-PartTenderingTerms-8</assert>
	</rule>
	...
	<rule context="/*/cac:TenderingProcess[$noticeSubType = '8']">
		<assert id="ND-ProcedureFeaturesUnpublish-8" role="ERROR" diagnostics="ND-ProcedureFeaturesUnpublish" test="count(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:FieldsPrivacy) = 0">rule|text|ND-ProcedureFeaturesUnpublish-8</assert>
	</rule>
