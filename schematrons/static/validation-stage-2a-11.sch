...
<pattern id="EFORMS-validation-stage-2a-11" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/*/cac:TenderingProcess[$noticeSubType = '11']">
		...
		<assert id="BR-BT-00135-0016" role="ERROR" diagnostics="ND-ProcedureTenderingProcess_BT-135-Procedure" test="count(cac:ProcessJustification[cbc:ProcessReasonCode/@listName='direct-award-justification']/cbc:ProcessReason) = 0">rule|text|BR-BT-00135-0016</assert>
