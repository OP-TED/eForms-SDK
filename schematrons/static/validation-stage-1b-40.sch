...
<pattern id="EFORMS-validation-stage-1b-40" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/*/cac:ProcurementProjectLot[$noticeSubType = '40']">
		...
		<assert id="ND-PartTenderingTerms-40" role="ERROR" diagnostics="ND-PartTenderingTerms" test="count(cac:TenderingTerms) &gt; 0">rule|text|ND-PartTenderingTerms-40</assert>
	</rule>
	<rule context="/*/cac:ProcurementProjectLot/cac:ProcurementProject[$noticeSubType = '40']">
		<assert id="ND-PartValueEstimate-40" role="ERROR" diagnostics="ND-PartValueEstimate" test="count(cac:RequestedTenderTotal) = 0">rule|text|ND-PartValueEstimate-40</assert>
	</rule>
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingProcess[$noticeSubType = '40']">
		...
		<assert id="ND-PartPreviousPlanning-40" role="ERROR" diagnostics="ND-PartPreviousPlanning" test="count(cac:NoticeDocumentReference) = 0">rule|text|ND-PartPreviousPlanning-40</assert>
	</rule>
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingTerms[$noticeSubType = '40']">
		...
		<assert id="ND-PartProcurementDocument-40" role="ERROR" diagnostics="ND-PartProcurementDocument" test="count(cac:CallForTendersDocumentReference) = 0">rule|text|ND-PartProcurementDocument-40</assert>
