...
<pattern id="EFORMS-validation-stage-1b-15" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/*/cac:ProcurementProjectLot[$noticeSubType = '15']">
		...
		<assert id="ND-PartTenderingTerms-15" role="ERROR" diagnostics="ND-PartTenderingTerms" test="count(cac:TenderingTerms) &gt; 0">rule|text|ND-PartTenderingTerms-15</assert>
	</rule>
	<rule context="/*/cac:ProcurementProjectLot/cac:ProcurementProject[$noticeSubType = '15']">
		...
		<assert id="ND-PartValueEstimate-15" role="ERROR" diagnostics="ND-PartValueEstimate" test="count(cac:RequestedTenderTotal) = 0">rule|text|ND-PartValueEstimate-15</assert>
	</rule>
	...
	<rule context="/*/cac:TenderingProcess[$noticeSubType = '15']">
		<assert id="ND-ProcedureFeaturesUnpublish-15" role="ERROR" diagnostics="ND-ProcedureFeaturesUnpublish" test="count(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:FieldsPrivacy) = 0">rule|text|ND-ProcedureFeaturesUnpublish-15</assert>
	</rule>
