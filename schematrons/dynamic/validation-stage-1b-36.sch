...
<pattern id="EFORMS-validation-stage-1b-36" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/*/cac:ProcurementProjectLot[$noticeSubType = '36']">
		...
		<assert id="ND-PartTenderingTerms-36" role="ERROR" diagnostics="ND-PartTenderingTerms" test="count(cac:TenderingTerms) &gt; 0">rule|text|ND-PartTenderingTerms-36</assert>
	</rule>
	<rule context="/*/cac:ProcurementProjectLot/cac:ProcurementProject[$noticeSubType = '36']">
		...
		<assert id="ND-PartValueEstimate-36" role="ERROR" diagnostics="ND-PartValueEstimate" test="count(cac:RequestedTenderTotal) = 0">rule|text|ND-PartValueEstimate-36</assert>
	</rule>
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingTerms[$noticeSubType = '36']">
		...
		<assert id="ND-PartProcurementDocument-36" role="ERROR" diagnostics="ND-PartProcurementDocument" test="count(cac:CallForTendersDocumentReference) = 0">rule|text|ND-PartProcurementDocument-36</assert>
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingTerms/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:StrategicProcurement[$noticeSubType = '36']">
		<assert id="ND-EEDInformationLot-36" role="ERROR" diagnostics="ND-EEDInformationLot" test="count(efac:StrategicProcurementInformation) = 0">rule|text|ND-EEDInformationLot-36</assert>
	</rule>
	...
	<rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeResult[$noticeSubType = '36']">
		...
		<assert id="ND-NoticeValueUnpublish-36" role="ERROR" diagnostics="ND-NoticeValueUnpublish" test="count(efac:FieldsPrivacy) = 0">rule|text|ND-NoticeValueUnpublish-36</assert>
	</rule>
