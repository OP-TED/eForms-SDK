...
<pattern id="EFORMS-validation-stage-1b-34" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/*/cac:ProcurementProjectLot[$noticeSubType = '34']">
		...
		<assert id="ND-PartTenderingTerms-34" role="ERROR" diagnostics="ND-PartTenderingTerms" test="count(cac:TenderingTerms) &gt; 0">rule|text|ND-PartTenderingTerms-34</assert>
	</rule>
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingTerms[$noticeSubType = '34']">
		...
		<assert id="ND-PartProcurementDocument-34" role="ERROR" diagnostics="ND-PartProcurementDocument" test="count(cac:CallForTendersDocumentReference) = 0">rule|text|ND-PartProcurementDocument-34</assert>
