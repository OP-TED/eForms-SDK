...
<pattern id="EFORMS-validation-stage-2a-T02" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="/*/cac:ContractingParty">
        ...
        <assert id="R-CG1-KVY" role="ERROR" diagnostics="ND-ContractingParty_BT-740-Procedure-Buyer" test="cac:ContractingPartyType/cbc:PartyTypeCode[@listName='buyer-contracting-type']">rule|text|R-CG1-KVY</assert>
    </rule>
    ...
    <rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeResult/efac:SettledContract">
        <assert id="R-H92-ZTE" role="ERROR" diagnostics="ND-SettledContract_BT-145-Contract" test="cbc:IssueDate">rule|text|R-H92-ZTE</assert>
