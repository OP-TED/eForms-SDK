...
<pattern id="EFORMS-validation-stage-2a-16" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms">
        <assert id="R-ID7-J4X" role="ERROR" diagnostics="ND-LotTenderingTerms_BT-60-Lot" test="cbc:FundingProgramCode[@listName='eu-funded']">rule|text|R-ID7-J4X</assert>
        ...
        <assert id="R-2HL-8KP" role="ERROR" diagnostics="ND-LotTenderingTerms_BT-743-Lot" test="cac:ContractExecutionRequirement[cbc:ExecutionRequirementCode/@listName='einvoicing']/cbc:ExecutionRequirementCode">rule|text|R-2HL-8KP</assert>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:PostAwardProcess">
        <assert id="R-6NC-I79" role="ERROR" diagnostics="ND-PostAwardProcess_BT-92-Lot" test="cbc:ElectronicOrderUsageIndicator">rule|text|R-6NC-I79</assert>
        <assert id="R-N4G-LEC" role="ERROR" diagnostics="ND-PostAwardProcess_BT-93-Lot" test="cbc:ElectronicPaymentUsageIndicator">rule|text|R-N4G-LEC</assert>
    </rule>
