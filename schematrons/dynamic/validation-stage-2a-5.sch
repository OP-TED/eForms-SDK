...
<pattern id="EFORMS-validation-stage-2a-5" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="/*/cac:ContractingParty">
        <assert id="R-NKJ-0QQ" role="ERROR" diagnostics="ND-ContractingParty_BT-610-Procedure-Buyer" test="cac:ContractingActivity[cbc:ActivityTypeCode/@listName='entity-activity']/cbc:ActivityTypeCode[@listName='entity-activity']">rule|text|R-NKJ-0QQ</assert>
