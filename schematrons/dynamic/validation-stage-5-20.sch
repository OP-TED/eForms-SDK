...
<pattern id="EFORMS-validation-stage-5-20" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension">
        <assert id="R-2KO-1EH" role="ERROR" diagnostics="ND-RootExtension_OPP-070-notice" test="(../../../../cbc:NoticeTypeCode/normalize-space(text()) = 'cn-social')">rule|text|R-2KO-1EH</assert>
    </rule>
</pattern>
