...
<pattern id="EFORMS-validation-stage-2a-E1" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms">
        ...
        <assert id="R-JXQ-6J8" role="ERROR" diagnostics="ND-LotTenderingTerms_BT-97-Lot" test="cac:Language/cbc:ID">rule|text|R-JXQ-6J8</assert>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingProcess/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:AnswerReceptionPeriod">
        <assert id="R-T61-0YT" role="ERROR" diagnostics="ND-PMCAnswersDeadline_BT-800_d_-Lot" test="cbc:EndDate">rule|text|R-T61-0YT</assert>
        <assert id="R-0MZ-COQ" role="ERROR" diagnostics="ND-PMCAnswersDeadline_BT-800_t_-Lot" test="cbc:EndTime">rule|text|R-0MZ-COQ</assert>
    </rule>
