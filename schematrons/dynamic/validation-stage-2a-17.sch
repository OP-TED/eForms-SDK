...
<pattern id="EFORMS-validation-stage-2a-17" xmlns="http://purl.oclc.org/dsdl/schematron">
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingProcess/cac:AuctionTerms">
        <assert id="R-LTD-XCL" role="ERROR" diagnostics="ND-AuctionTerms_BT-767-Lot" test="cbc:AuctionConstraintIndicator">rule|text|R-LTD-XCL</assert>
    </rule>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingProcess">
        <assert id="R-I70-F83" role="ERROR" diagnostics="ND-LotTenderingProcess_BT-115-Lot" test="cbc:GovernmentAgreementConstraintIndicator">rule|text|R-I70-F83</assert>
        ...
        <assert id="R-Q9M-JX7" role="ERROR" diagnostics="ND-LotTenderingProcess_BT-765-Lot" test="cac:ContractingSystem[cbc:ContractingSystemTypeCode/@listName='framework-agreement']/cbc:ContractingSystemTypeCode">rule|text|R-Q9M-JX7</assert>
        <assert id="R-9LU-FJK" role="ERROR" diagnostics="ND-LotTenderingProcess_BT-766-Lot" test="cac:ContractingSystem[cbc:ContractingSystemTypeCode/@listName='dps-usage']/cbc:ContractingSystemTypeCode">rule|text|R-9LU-FJK</assert>
    </rule>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms">
        ...
        <assert id="R-S0K-ZIG" role="ERROR" diagnostics="ND-LotTenderingTerms_BT-70-Lot" test="cac:ContractExecutionRequirement[cbc:ExecutionRequirementCode/@listName='conditions']/cbc:Description">rule|text|R-S0K-ZIG</assert>
        <assert id="R-HYE-SR4" role="ERROR" diagnostics="ND-LotTenderingTerms_BT-71-Lot" test="cac:TendererQualificationRequest[not(cbc:CompanyLegalFormCode)][not(cac:SpecificTendererRequirement/cbc:TendererRequirementTypeCode[@listName='missing-info-submission'])][not(cac:SpecificTendererRequirement/cbc:TendererRequirementTypeCode[@listName='selection-criteria-source'])]/cac:SpecificTendererRequirement[cbc:TendererRequirementTypeCode/@listName='reserved-procurement']/cbc:TendererRequirementTypeCode">rule|text|R-HYE-SR4</assert>
        ...
        <assert id="R-AAS-UWX" role="ERROR" diagnostics="ND-LotTenderingTerms_BT-751-Lot" test="cac:RequiredFinancialGuarantee/cbc:GuaranteeTypeCode[@listName='tender-guarantee-required']">rule|text|R-AAS-UWX</assert>
        <assert id="R-NV0-2AR" role="ERROR" diagnostics="ND-LotTenderingTerms_BT-761-Lot" test="cac:TendererQualificationRequest[not(cac:SpecificTendererRequirement)]/cbc:CompanyLegalFormCode">rule|text|R-NV0-2AR</assert>
        <assert id="R-RSY-I86" role="ERROR" diagnostics="ND-LotTenderingTerms_BT-764-Lot" test="cac:ContractExecutionRequirement[cbc:ExecutionRequirementCode/@listName='ecatalog-submission']/cbc:ExecutionRequirementCode">rule|text|R-RSY-I86</assert>
        ...
        <assert id="R-SNA-9YO" role="ERROR" diagnostics="ND-LotTenderingTerms_OPT-060-Lot" test="cac:ContractExecutionRequirement[cbc:ExecutionRequirementCode/@listName='conditions']/cbc:ExecutionRequirementCode">rule|text|R-SNA-9YO</assert>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:ProcurementProject/cac:ContractExtension">
        <assert id="R-SOW-1XJ" role="ERROR" diagnostics="ND-OptionsAndRenewals_BT-58-Lot" test="cbc:MaximumNumberNumeric">rule|text|R-SOW-1XJ</assert>
    </rule>
    ...
    <rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:PaymentTerms">
        <assert id="R-8Y2-1GF" role="ERROR" diagnostics="ND-PaymentTerms_BT-77-Lot" test="cbc:Note">rule|text|R-8Y2-1GF</assert>
    </rule>
